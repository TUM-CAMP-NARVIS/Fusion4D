...
__global__ void associate_pts_to_jtj_kernel_stepCount(int const *dev_ngns_indices, int const *dev_vts_num,
...
__global__ void associate_pts_to_jtj_kernel_stepAggreg_Diag(short2 *dev_jtj_2d_infos,
...
__global__ void associate_pts_to_jtj_kernel_stepAggreg_OffDiag(short2 *dev_jtj_2d_infos,
															   HessianBlockInfoCuda *dev_block_info_buf,
...
__global__ void associate_pts_to_jtj_kernel_stepSavingPtIdx(int *dev_vt_indices_for_jtj, float *dev_vt_weights_for_jtj,
