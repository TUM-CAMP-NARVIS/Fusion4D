...
namespace VolumetricFusionCuda
{
	...
	__global__ void fused_warped_model_with_curr(VolumeDataGPU volume_model, VolumeConstDataGPU volume_curr,
	...
	__global__ void remove_extra_free_space()
	{
	}

#define VOLUME_BLUR_RADIUS 3
	__global__ void volume_filter_kernel(VolumeConstDataGPU volume, float *dev_vxl_data_f, int vxls_per_cube, int cube_size_in_vxl, float thres_weight)
	{
