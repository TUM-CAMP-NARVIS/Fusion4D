...
__global__ void connect_ed_nodes_two_levels_kernel(short2 *dev_jtj_2d_infos,
...
__global__ void connect_ed_nodes_1st_level_kernel_vDist(short2 *dev_jtj_2d_infos,
														DeformGraphNodeCuda *dev_ed_nodes,
...
// one ed nodes per thread
//  each kernel only writes to one element of dev_jtj_2d_infos, not its symmetric element
__global__ void connect_ed_nodes_same_level_kernel(short2 *dev_jtj_2d_infos,
												   DeformGraphNodeCuda *dev_ed_nodes,
												   int const *dev_ed_nodes_num_all_levels,
...
__global__ void complete_ed_nodes_neighbors_kernel(short2 const *dev_jtj_2d_infos, // the one before running kernel ComposeJtJ2DInfoRegTerm_Kernal
...
__global__ void setup_ed_nodes_reg_term_kernel_vFast(ushort2 *dev_reg_node_pairs_list_buf, int node_pairs_list_buf_size, int *dev_global_reg_count,
...
__global__ void setup_ed_nodes_reg_term_kernel_vFast2(ushort2 *dev_reg_node_pairs_list_buf, int node_pairs_list_buf_size, int *dev_global_reg_count,
													  short2 *dev_jtj_2d_infos, DeformGraphNodeCuda const *dev_ed_nodes, int const *dev_ed_nodes_num_all_levels,
													  HessianBlockInfoCuda *dev_block_info_buf, int block_info_buf_size, int *dev_jtj_blks_count)
{
	const int ed_nodes_num = *dev_ed_nodes_num_all_levels;
...
__global__ void setup_ed_nodes_reg_term_kernel(ushort2 *dev_reg_node_pairs_list_buf, int node_pairs_list_buf_size, int *dev_global_reg_count,
